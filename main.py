...
def test_getHotelListFilter():
    search = Search(
        ["de"],
        select___avail=HotelFilters.OTA,
        avail_alert=0,
        select___rooms=HotelFilters.EASI_CHANNEL,
        rooms_alert=0,
        select___price=HotelFilters.EASI_CHANNEL,
        price_alert=0,
    )
...
if __name__ == "__main__":
    ...
    req = test_getHotelListFilter()

    resp = client.request(
        getenv("MSS_SERVICE_URL"),
        MethodName.GetHotelListByFilter,
        req,
