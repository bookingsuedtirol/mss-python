...
if __name__ == "__main__":
    ...
    # # print(is_valid(resp, file=True, filename="./XML-samples/MSS_Hotel-List-1721202439420.xml"))
    # a = copy.copy(resp[2])
    # # a.tag = "bruh"
    # print(a)
    # client.add_child_xml(a,resp)
    # print(resp[:])
...
# def getBaseDict()->dict:
#     """
#     Returns the base dictionary (which will later be converted to an XML) with the mandatory fields.
#     """
...
#     temp["password"] = PASSWORD
#     temp["source"] = SOURCE
#     data = {"header":{"credentials": temp}}

#     temp["lang"] = "de"
#     data["request"] = {"search":temp}
